          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center relative py-6 sm:py-10">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute top-[28%] -left-4 sm:-left-12 lg:-left-20 bg-gradient-to-br from-white/95 via-pink-50/90 to-rose-100/80 backdrop-blur-md px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-full shadow-[0_8px_25px_rgba(232,74,116,0.18)] flex items-center gap-2 text-xs sm:text-xs font-bold text-rose-950 border border-white/95 z-20 hover:scale-105 transition-transform duration-300 cursor-pointer whitespace-nowrap"
              >
